...
const HomePage = () => (
  <div style={{ padding: '20px' }}>
    ...
    <section style={{ display: 'flex', justifyContent: 'space-around', marginBottom: '40px' }}>
      <div style={{ padding: '20px', background: '#eee', width: '30%', textAlign: 'center' }}>State 1</div>
      <div style={{ padding: '20px', background: '#eee', width: '30%', textAlign: 'center' }}>State 2</div>
      <div style={{ padding: '20px', background: '#eee', width: '30%', textAlign: 'center' }}>State 3</div>
    </section>
