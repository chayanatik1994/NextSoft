...
const HomePage = () => {
  return (
    <div className="bg-white text-gray-800">
      ...
      <section className="bg-gradient-to-r from-purple-700 to-purple-500 text-white w-full h-[410px] flex flex-col justify-center">
  <div className="w-full flex flex-col md:flex-row justify-center gap-8 text-center px-4 sm:px-6">
    <div>
