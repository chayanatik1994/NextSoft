    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col md:flex-row gap-10 items-start">
        <div className="md:w-2/5 w-full">
          <img src={app.image} alt={app.title} className="w-full h-72 object-cover rounded-xl" />
        </div>
        ...
        <div className="md:w-3/5 w-full">
          ...
          <div className="grid grid-cols-3 gap-6 mt-8 text-center">
            ...
            <div>
              <img src={ratingIcon} alt="Rating" className="w-8 h-8 mx-auto mb-2" />
            ...
            <div>
              ...
              <p className="font-semibold">{app.reviews.length.toLocaleString()}</p>
          ...
          <button
            ...
            className="mt-8 px-20 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600"
          >
            Install App
          </button>
        </div>
