...
const AppDetails = () => {
  ...
  useEffect(() => {
    fetch("/appsData.json")
      ...
      .then((data) => {
        ...
        setIsInstalled(installedApps.some(app => app.id === selectedApp.id));
      })
      .catch((err) => {
  ...
  const handleInstall = () => {
    ...
    setIsInstalled(true); // Disable install button
    // Show a success toast message (You can use a library like react-toastify here)
  ...
  const handleUninstall = () => {
    ...
    setIsInstalled(false); // Enable install button
    alert(`${app.title} uninstalled successfully!`);
  };
        ...
        <div className="md:w-3/5 w-full">
          ...
          <div className="mt-8">
            <button
              ...
              className={`px-20 py-2 ${isInstalled ? 'bg-gray-500 cursor-not-allowed' : 'bg-green-500'} text-white rounded-lg hover:bg-green-600`}
