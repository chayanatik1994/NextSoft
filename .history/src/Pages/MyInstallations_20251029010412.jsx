...
const AppDetails = () => {
  ...
  // Default rating data if not available
        ...
        <div className="md:w-3/5 w-full">
          ...
          <div className="grid grid-cols-3 gap-6 mt-8 text-center">
            <div>
              ...
              <p className="font-semibold">{app.downloads?.toLocaleString() || 0}</p> {/* Fallback */}
              <p className="text-gray-500 text-sm">Downloads</p>
            </div>
            <div>
              <img src={ratingIcon} alt="Average Rating" className="w-8 h-8 mx-auto mb-2" />
              <p className="font-semibold">{app.ratingAvg?.toFixed(1) || 0}</p> {/* Fallback */}
              <p className="text-gray-500 text-sm">Rating</p>
            </div>
            <div>
              <img src={reviewIcon} alt="Total Reviews" className="w-8 h-8 mx-auto mb-2" />
              <p className="font-semibold">{app.reviews?.toLocaleString() || 0}</p> {/* Fallback */}
