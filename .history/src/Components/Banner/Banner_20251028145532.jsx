  ...
  return (
    <div className="flex flex-col justify-center items-center text-center h-screen p-8 bg-purple-50">
      <h1 className="text-5xl font-extrabold">
        We Build <br/>
        <span className="text-purple-600  px-2 py-1 rounded-xl">Productive</span> Apps
      </h1>
     <p className="mt-4 text-lg max-w-2xl">
  At SoftNext Teach, we craft innovative apps designed to make everyday life simpler, 
  <br />
  Our goal is to turn your ideas into digital experiences that truly make an impact.
</p>
      <div className="flex space-x-4 mt-6">
        <button className="flex items-center px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
