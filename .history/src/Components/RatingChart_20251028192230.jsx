...
/**
 * Renders a horizontal bar chart showing rating distribution.
 * @param {Array<Object>} data - Array of objects like: 
 * [{ name: '5 Star', count: 9500 }, { name: '4 Star', count: 6300 }, ...]
 * @param {string} barColor - Hex color for the bars (e.g., '#0070c9').
 */
const RatingDistributionChart = ({ data, barColor = '#41c300' }) => {
  // Find the maximum value to ensure the X-Axis scale is appropriate
