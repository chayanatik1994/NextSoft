...
const TrendingApps = () => {
  ...
  const [showAll, setShowAll] = useState(false); // boolean toggle
  ...
  const appsToShow = showAll ? apps : apps.slice(0, 8); // show all or first 8
        ...
        {appsToShow.map((app) => (
          ...
          >
            ...
            <div className="w-full text-left mt-2">
              ...
              <p className="text-gray-500 text-xs">{app.companyName}</p>
            </div>
